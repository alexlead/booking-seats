    ...
    <ul>
        <li>
            ...
            <div class='bottomBut'>
                ...
                <div class="col-50">
                    <div class='nextBut'><?php echo $orderStep['button-next']; ?>
                    </div>
                </div>
            </div>
        </li>
        ...
        <li>
            ...
            <div class='bookFormConstructor'>
                <div id="dateSeats" class="table-wrapper">
                    <div>
                        <div>
                            <p><span class="orderDate"></span></p>
                        </div>
                    </div>
                </div>
            ...
            <div class='bottomBut'>
                <div class="col-50">
                    <div class='prevBut enStep'><?php echo $orderStep['button-back']; ?></div>
                </div>
                <div class="col-50">
                    <div class='nextBut'><?php echo $orderStep['button-next']; ?></div>
                </div>
            </div>
        </li>
        <li>
            ...
            <div class='bookFormConstructor'>
                <div id="dateSeatsOrder" class="table-wrapper">
                    <div>
                        <div>
                            <p><span class="orderDate"></span><br /><span class="orderTime"></span>, <?php echo $orderStep['details-3']; ?><span class="orderSeats"></span></p>
                        </div>
                    </div>
                </div>
...
<script src='<?php echo $ALWPDBF_vars->jsURL(); ?>jquery-3.7.1.min.js'></script>
